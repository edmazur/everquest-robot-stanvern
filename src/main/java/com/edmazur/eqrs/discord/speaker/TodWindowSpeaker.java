  ...
  public void run() {
    try {
      ...
      discord.sendMessage(getChannel(),
          ...
          + "\n"
          + "**This doesn't have features XYZ - why aren't we using the CARE bot?**\n"
          + "- The plan is to merge the best features of the CARE bot and BL/FoW bot. Both systems "
          + "are mature and battle-tested. Both have unique features.\n"
          + "- The most commonly requested features from the CARE about that will be added are (a) "
          + "visual progress bars in the #timers channel and (b) relative (e.g. \"5 minutes ago\") "
          + "ToD input.\n"
